...
def observe_region(frame_bgra: np.ndarray, region: tmmod.Region,
    ...
    if kind == "T":
        ...
        # look up existing i$ of same size
        obs_flat = rgba
        exact = None
        ...
        images.append(ImageObservation(
            ...
            exact_name=exact, near_matches=near[:5],
        ))

    # C/N/W/H are stateless or not handled here
